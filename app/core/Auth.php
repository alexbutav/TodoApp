...
class Auth {
        ...
        public static function attempt(User $user, String $password) {
            ...
            if( intval($user->is_admin)) self::setAdmin();
        ...
        protected static function checkAuth() {
            ...
            if( !array_key_exists('logged_in', $_SESSION['auth'])) $_SESSION['auth']['logged_in'] = false;
            if( !array_key_exists('is_admin', $_SESSION['auth'])) $_SESSION['auth']['is_admin'] = false;
        }
    }
